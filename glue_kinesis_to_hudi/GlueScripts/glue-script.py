...
# ensure the incoming record has the correct current schema, new fresh columns are fine,
# if a column exists in current schema but not in incoming record then manually add before inserting
